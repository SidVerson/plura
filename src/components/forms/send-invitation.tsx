  ...
  const onSubmit = async (values: z.infer<typeof userDataSchema>) => {
    try {
      ...
      await saveActivityLogsNotification({
        agencyId: agencyId,
        description: `Приглашение отправлено на адрес ${res.email}`,
  ...
  return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Пользователю будет отправлено приглашение. Пользователи, которым уже
            было отправлено приглашение на их email, не получат новое приглашение.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            ...
            >
              ...
              <Button
                  ...
                  type="submit"
              >
                {form.formState.isSubmitting ? <Loading /> : 'Отправить приглашение'}
              </Button>
            </form>
          </Form>
        </CardContent>
