    ...
    >
      ...
      >
        <div>
                  ...
                  <SheetClose>
                    <Button
                      ...
                      onClick={() => {
                        setOpen(
                          <CustomModal
                            title="Создайте субаккаунт"
                            subheading="Вы можете переключаться между своим агентским аккаунтом и субаккаунтом на боковой панели"
                          >
                            <SubAccountDetails
          ...
          <p className="text-muted-foreground text-xs mb-2">Меню</p>
