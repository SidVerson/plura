...
const PipelineInfoBar = ({ pipelineId, pipelines, subAccountId }: Props) => {
  ...
  const handleClickCreatePipeline = () => {
    setOpenModal(
        <CustomModal
            title="Создать Pipeline"
            subheading="Pipelines позволяет группировать тикеты в различные этапы и отслеживать бизнес-процессы в одном месте."
        >
        ...
        <div className="flex items-end gap-2">
          ...
          >
            ...
            <PopoverContent className="w-[200px] p-0">
              <Command>
                <CommandEmpty>Нет найденных pipeline.</CommandEmpty>
                <CommandGroup>
